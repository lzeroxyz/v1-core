...
export interface IGoodKernelInterface extends utils.Interface {
  contractName: "IGoodKernel";
  functions: {
...
export interface IGoodKernel extends BaseContract {
  contractName: "IGoodKernel";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGoodKernelInterface;
  ...
  callStatic: {
    createGood(
      createGoodInput: CreateGoodInputStruct,
      overrides?: CallOverrides
    ): Promise<[BigNumber, number] & { state: number }>;
