...
export interface GoodKernelInterface extends utils.Interface {
  contractName: "GoodKernel";
  functions: {
...
export interface GoodKernel extends BaseContract {
  contractName: "GoodKernel";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoodKernelInterface;
  ...
  functions: {
    ...
    createGoodServiceVoucher(
      createGoodServiceVoucherInput: CreateGoodServiceVoucherInputStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    removeGoodServiceVoucher(
      removeGoodServiceVoucherInput: RemoveGoodServiceVoucherInputStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    createGood(
      ...
      [BigNumber, number] & { mintedGoodId: BigNumber; mintedGoodState: number }
    >;
    ...
    createGoodService(
      ...
      [BigNumber, number] & {
        mintedGoodServiceId: BigNumber;
        mintedGoodServiceState: number;
      }
    >;
