...
export interface GoodServiceVoucherTokenFactoryMockInterface
  extends utils.Interface {
  contractName: "GoodServiceVoucherTokenFactoryMock";
  functions: {
...
export interface GoodServiceVoucherTokenFactoryMock extends BaseContract {
  contractName: "GoodServiceVoucherTokenFactoryMock";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoodServiceVoucherTokenFactoryMockInterface;
  ...
  functions: {
    ...
    "mintBatch(address,uint256[],string[])"(
      to: string,
      amounts: BigNumberish[],
      tokenUris: string[],
      overrides?: Overrides & { from?: string | Promise<string> }
