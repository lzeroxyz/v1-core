...
export interface PaymentPoolInterface extends utils.Interface {
  contractName: "PaymentPool";
  functions: {
...
export interface PaymentPool extends BaseContract {
  contractName: "PaymentPool";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PaymentPoolInterface;
