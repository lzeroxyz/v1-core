...
export interface PaymentKernelInterface extends utils.Interface {
  contractName: "PaymentKernel";
  functions: {
...
export interface PaymentKernel extends BaseContract {
  contractName: "PaymentKernel";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PaymentKernelInterface;
